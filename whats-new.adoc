...
Aunque anunciamos el fin de disponibilidad de estos productos, NetApp seguirá ofreciendo soporte hasta el 31 de mayo de 2027 como mínimo. https://mysupport.netapp.com/info/communications/CPC-00578.html["Consulte los detalles sobre el fin de la disponibilidad de Global File Cache de NetApp"^].
